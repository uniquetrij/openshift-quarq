...
import com.infy.stg.quarq.domain.User;
import com.infy.stg.quarq.service.InvalidPasswordException;
import com.infy.stg.quarq.service.MailService;
import com.infy.stg.quarq.service.UserService;
import com.infy.stg.quarq.service.UsernameAlreadyUsedException;
import com.infy.stg.quarq.service.dto.PasswordChangeDTO;
import com.infy.stg.quarq.service.dto.UserDTO;
import com.infy.stg.quarq.web.rest.errors.EmailAlreadyUsedException;
import com.infy.stg.quarq.web.rest.errors.EmailNotFoundException;
import com.infy.stg.quarq.web.rest.errors.LoginAlreadyUsedException;
import com.infy.stg.quarq.web.rest.vm.KeyAndPasswordVM;
import com.infy.stg.quarq.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.infy.stg.quarq.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
