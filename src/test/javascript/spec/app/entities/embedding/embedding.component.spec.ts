...
import { EmbeddingComponent } from 'app/entities/embedding/embedding.component';
...
describe('Component Tests', () => {
  describe('Embedding Management Component', () => {
    let comp: EmbeddingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(EmbeddingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.embeddings && comp.embeddings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
